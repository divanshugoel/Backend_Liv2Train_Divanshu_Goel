...
/**
 * TrainingCentreRepository is an interface for performing basic CRUD operations
 * on a repository for a specific type.
 * 
 * @param <TrainingCentre> the domain type the repository manages
 * @param <Integer>        the type of the id of the entity the repository
 *                         manages
 * 
...
public interface TrainingCentreRepository extends CrudRepository<TrainingCentre, Integer> {
	 ...
	 * @return the trainingCentre with the given email or
	...
	/**
	 * findAllis a method that returns all instances of the trainingCentre in
	 * descending order sorted by their time of creation .
	 *
	 * @return all trainingCentre in a list since 1.0 version 1.0
	 */
